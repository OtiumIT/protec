...
export const rulesImoveis: RuleDocumentation[] = [
  ...
  },
  {
    ...
    descricao:
      'A partir de 2027, locacao de imoveis passa a pagar IBS e CBS com redutor da aliquota (nao "redutor de ajuste"). Locacao residencial: redutor da aliquota 70%; hospedagem/temporada: 50%. O perfil "ambos" aplica os dois redutores proporcionalmente. Redutor social Art. 260: R$ 600/mes por imovel residencial, deduzido da BASE de calculo. Quando misto (residencial+comercial), informar receita_locacao_residencial_anual e receita_locacao_nao_residencial_anual separadamente.',
    ...
    observacoes: [
      ...
      'Redutor social (Art. 260 LC 214/2025): R$ 600/mês por imóvel residencial deduzido da BASE de cálculo. Locação não residencial não tem redutor social nem redutor da alíquota.',
