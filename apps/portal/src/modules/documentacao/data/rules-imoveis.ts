...
export const rulesImoveis: RuleDocumentation[] = [
  ...
  },
  {
    ...
    descricao:
      'A partir de 2027, locacao de imoveis (residenciais e nao residenciais) passa a pagar IBS e CBS com redutor setorial da aliquota (nao "redutor de ajuste"). Locacao de longa duracao (acima de 90 dias) e locacao nao residencial utilizam redutor de 70%; curta temporada (ate 90 dias, equiparada a hotelaria) utiliza redutor de 50%. O perfil "ambos" aplica os dois redutores proporcionalmente. Redutor social Art. 260 LC 214/2025 (redacao dada pela LC 227/2026): valor nominal R$ 600/mes por imovel residencial, corrigido mensalmente pelo IPCA a partir da publicacao da LC 214 (16/01/2025), deduzido da BASE apenas na parcela de longa duracao - curta temporada (ate 90 dias) NAO recebe redutor social. Quando misto (residencial+comercial), informar receita_locacao_residencial_anual e receita_locacao_nao_residencial_anual separadamente.',
    ...
    embasamento_legal: [
      ...
      },
      {
        norma: 'LC n. 214/2025',
        artigo: 'Art. 261',
        descricao: 'Redutores de aliquota para locacao de imoveis.',
        url: 'https://www.planalto.gov.br/ccivil_03/leis/lcp/lcp214.htm',
      },
      {
        norma: 'LC n. 214/2025',
        artigo: 'Art. 255 a 260',
        descricao: 'Cronograma de transicao do IBS.',
        url: 'https://www.planalto.gov.br/ccivil_03/leis/lcp/lcp214.htm',
      },
    ],
    variaveis: [
      ...
      },
      {
        ...
        descricao: '50% para hospedagem/temporada (Airbnb)',
        tipo: 'percentual',
      },
    ],
    exemplo_numerico: {
    ...
    observacoes: [
      '2027/2028: CBS plena (~9%) + IBS fixo de 0,1% - ambos com redutor de 70% (longa duração) ou 50% (curta temporada) para locação.',
      'A partir de 2029: CBS plena + IBS progressivo (10% em 2029, 20% em 2030, 30% em 2031, 40% em 2032, 100% em 2033).',
      'O redutor de 70% resulta em carga efetiva próxima a 8% sobre receita após 2033; o de 50% resulta em ~14%.',
      ...
      'Carteira mista (residencial + não residencial): imóveis não residenciais utilizam taxa ponderada pela composição longa/curta da carteira, sem redutor social.',
    ...
    alertas: [
      ...
      {
        tipo: 'atencao',
        mensagem: 'Locação residencial: redutor 70% (longa duração) ou 50% (curta temporada). Não residencial: taxa ponderada pela composição longa/curta.',
      },
    ],
  },
  {
  ...
  },
  {
    ...
    descricao:
      'A Pessoa Física que recebe aluguéis só é contribuinte de IBS/CBS se atender a um dos critérios: (a) possuir mais de 3 imóveis E receita > R$ 240.000/ano, ou (b) receita > R$ 288.000/ano (20% acima de 240k), independentemente do número de imóveis. Caso contrário, a PF paga apenas o IR via Carnê-Leão.',
    formula: 'Contribuinte = (Imoveis > 3 \\land Receita > 240k) \\lor (Receita > 288k)',
    formula_explicada:
      'Se a quantidade de imóveis for maior que 3 E a receita anual for maior que R$ 240.000, a PF é contribuinte. OU se a receita for maior que R$ 288.000 (independente do número de imóveis), também é contribuinte.',
    embasamento_legal: [
      {
        norma: 'LC nº 214/2025',
        artigo: 'Art. 261',
        paragrafo: '§ 4º',
        descricao: 'Define os critérios para enquadramento da PF como contribuinte de IBS/CBS na locação.',
        url: 'https://www.planalto.gov.br/ccivil_03/leis/lcp/lcp214.htm',
      },
    ],
    variaveis: [
      {
        ...
        descricao: 'Número total de imóveis do locador',
        tipo: 'numero',
      },
      {
        nome: 'Receita_Anual',
      ...
      {
        nome: 'Limite_Receita',
        descricao: 'R$ 240.000 (limite para verificação com nº de imóveis)',
        tipo: 'moeda',
      },
      {
        nome: 'Limite_Receita_Absoluto',
        descricao: 'R$ 288.000 (limite absoluto, independente de nº de imóveis)',
        tipo: 'moeda',
      },
      {
        nome: 'Limite_Imoveis',
        descricao: '3 imóveis (limite para verificação com receita)',
        tipo: 'numero',
      },
    ],
    exemplo_numerico: {
      ...
      dados_entrada: {
        cenarios: [
          ...
          { imoveis: 1, receita: 300000, resultado: 'Contribuinte (>288k)' },
        ],
      },
      passos: [
        {
          ...
          calculo: '2 <= 3 E 200k <= 288k',
          resultado: 'Não contribuinte - paga apenas IR Carnê-Leão',
        },
        {
          ordem: 2,
          descricao: 'Cenário 2: 4 imóveis, R$ 250k/ano',
          calculo: '4 > 3 E 250k > 240k',
          resultado: 'Contribuinte IBS/CBS - IR + IBS/CBS',
        },
        {
          ordem: 3,
          descricao: 'Cenário 3: 1 imóvel, R$ 300k/ano',
          calculo: '300k > 288k (independente de imóveis)',
          resultado: 'Contribuinte IBS/CBS - IR + IBS/CBS',
        },
      ],
      resultado_final: {
        criterio_1: 'Mais de 3 imóveis + receita > R$ 240.000',
        criterio_2: 'Receita > R$ 288.000 (qualquer nº de imóveis)',
      },
    },
    observacoes: [
