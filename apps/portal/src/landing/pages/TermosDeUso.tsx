                ...
                <section className="mt-10 space-y-10">
                  <div id="objeto" className="scroll-mt-24">
                    ...
                    <p className="mt-2 text-slate-600 leading-relaxed text-[15px]">
                      O IATax é uma plataforma de inteligência fiscal e contábil que oferece ferramentas para validação de rating, simulação de cenários tributários (IN 2.306/2026), organização de clientes e arquivos fiscais. O serviço é prestado sob o modelo SaaS (Software as a Service) pela IATax Soluções Inteligentes.
                    </p>
                  </div>
