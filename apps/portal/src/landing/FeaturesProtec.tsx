...
export function FeaturesProtec() {
  return (
    <section id="funcionalidades" className="py-16 sm:py-24 bg-gradient-to-br from-[#1a4d3d] via-[#0f3428] to-[#0a2520]">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <ul className="mx-auto mt-12 grid max-w-2xl gap-8 sm:mt-16 lg:max-w-none lg:grid-cols-2 lg:gap-x-12 lg:gap-y-8">
          {features.map((feature) => (
            <li
              key={feature.id}
              className="rounded-xl border border-white/20 bg-white/5 p-6 shadow-lg backdrop-blur-sm transition-shadow hover:shadow-xl hover:bg-white/10"
            >
              <div className="flex gap-4">
                <div className="flex h-10 w-10 flex-shrink-0 items-center justify-center rounded-lg bg-[#e8dfd0]/20 text-[#e8dfd0]">
                  {feature.icon}
                </div>
                <div>
